...
"""
papa = cq.Workplane()
papa = papa.box(length = 10,width = 2,height = 2,centered = True,combine = True,clean = True)
...
Part1 = Part1.extrude(distance = 20,combine = True,clean = True,both = False,taper = None)
